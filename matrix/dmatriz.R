...
raw_counts <- read.delim(paste0('C:\\Users\\Usuário\\Downloads\\Bioinformatica\\TCGA\\COAD',  rnaseq_coad.dirs[1], '/', list.files(paste0('data/rnaseq/', rnaseq_coad.dirs[1]), pattern = '.tsv')), skip = 1)[-c(1:4), ]
...
for (i in rnaseq_coad.dirs[-1]) {
    tmp <- read.delim(paste0('C:\\Users\\Usuário\\Downloads\\Bioinformatica\\TCGA\\COAD',  i, '/', list.files(paste0('data/rnaseq_coad/', i), pattern = '.tsv')), skip = 1)[-c(1:4), ]
    tmp <- tmp[, 4]
...
saveRDS(raw_counts, file = 'C:\\Users\\Usuário\\Downloads\\Bioinformatica\\TCGA\\TCGA_COAD_RNASEQ.rds')
