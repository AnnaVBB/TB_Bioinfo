...
coldata <- coad_manifesto %>%
  ...
  rename(sample_type = cases.0.samples.0.tissue_type) # Renomear a coluna para 'sample_type'

# Verificar se há NA ou valores inválidos em 'sample_type'
...
print("Análise de expressão diferencial concluída e resultados salvos.")
